...
app.use(cors({
  origin: 'https://26fcsznz-4200.usw3.devtunnels.ms', // Configura el origen permitido
  methods: ['GET', 'POST', 'PUT', 'DELETE'], // Configura los métodos permitidos
  headers: ['Content-Type', 'Authorization'], // Configura los encabezados permitidos
}));
